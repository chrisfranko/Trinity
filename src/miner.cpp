...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    if (auxpow != NULL) {
        ...
        // print to log
        LogPrintf("TrinityMiner: AUX proof-of-work found; our hash: %s ; parent hash: %s ; target: %s\n",
               hash.GetHex().c_str(),
    ...
    else
    {
        ...
        // print to log
        LogPrintf("TrinityMiner: proof-of-work found; hashPoW: %s ; target: %s\n", hashPoW.GetHex().c_str(), hashTarget.GetHex().c_str());
    }
...
{
    LogPrintf("TrinityMiner miner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    ...
    {
        LogPrintf("TrinityMiner miner terminated\n");
        throw;
    }
}
