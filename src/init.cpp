...
std::string HelpMessage(HelpMessageMode hmm)
{
    ...
    strUsage += "  -pid=<file>            " + _("Specify pid file (default: trinity.pid)") + "\n";
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    else if (strAlgo == "GROESTL" || strAlgo == "groestl")
...
#endif
    // Make sure only a single Trinity process is using the data directory.
